...
export function AnchorSection() {
  ...
  return (
    <div ref={anchorRef} className="h-[100vh] md:h-[180vh] relative">
      <motion.div
        style={{ opacity: anchorOpacity, scale: anchorScale, y: anchorY, rotate: anchorRotate }}
        className="sticky top-0 h-screen flex items-center justify-center"
      >
        <div className="relative w-[85vw] md:w-[65vw] aspect-[4/5] max-w-4xl">
          <Image src="/images/16+Faces.jpg" alt="" fill className="object-cover grayscale contrast-125" />
